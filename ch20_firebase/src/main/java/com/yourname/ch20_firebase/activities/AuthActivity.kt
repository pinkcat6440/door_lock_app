...
import com.yourname.ch20_firebase.databinding.ActivityAuthBinding
...
import com.yourname.ch20_firebase.fragments.DashboardActivity
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.googleLoginBtn.setOnClickListener {
            val gso = GoogleSignInOptions.Builder(GoogleSignInOptions.DEFAULT_SIGN_IN)
                .requestIdToken(getString(com.yourname.ch20_firebase.R.string.default_web_client_id))
                .requestEmail()
                .build()
